...
def abrir_ventana_integrantes():
    ...
    integrantes = [
        {"nombre": "Gabriel Bernal", "codigo": "u20201f415", "rol": "Programador"},
        {"nombre": "Johan Moreno", "codigo": "u20201C105", "rol": "Programador"},
        {"nombre": "Jesus Lazo", "codigo": "u202019038", "rol": "Programador"},
        {"nombre": "Azariel Gonzales", "codigo": "u202111172", "rol": "Programador"}
    ]
...
ventana = tk.Tk()
ventana.title("MovieMatch - Búsqueda y Recomendación de Películas")

barra_superior = tk.Frame(ventana, bg="black")
barra_superior.pack(fill=tk.X)

nombre_app = tk.Label(barra_superior, text="MovieMatch", fg="white", bg="black", font=("Arial", 24, "bold"))
